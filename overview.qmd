...
* [{gptstudio}](https://github.com/MichelNivard/gptstudio) - easily incorporate use of large language models (LLMs) into their project workflows
* [{gpttools}](https://jameshwade.github.io/gpttools/) - extends gptstudio for R package developers
<!-- * [{askgpt}](https://github.com/jbgruber/askgpt) - chat interface build on top of OpenAI's API endpoints -->
<!-- * [{chatgpt}](https://github.com/jcrodriguez1989/chatgpt) - Interface to ChatGPT from R -->
<!-- * [{gptchatteR}](https://github.com/isinaltinkaya/gptchatteR) - experimental and unofficial wrapper for interacting with OpenAI GPT models in R-->
